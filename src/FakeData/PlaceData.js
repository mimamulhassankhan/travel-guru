export const placeData = [
    {
        id: 'PLC-1',
        name: 'Sajek',
        photo: '/Images/Image/Sajek.png',
        description: 'Sajek Valley - সাজেক ভ্যালি / মেঘের উপত্যকায় জীবন is an emerging tourist spot in Bangladesh situated among the hills of the Kasalong range of mountains in Sajek union, Baghaichhari Upazila in Rangamati District. The valley is 1,476 feet above sea level. Sajek valley is known as the Queen of Hills & Roof of Rangamati.',
        location:{
            lat: 23.383011,
            lng: 92.293782
        }
    ...
    },
    {
        id: 'PLC-4',
        name: 'Nijhum Dwip',
        photo: '/Images/Image/Nijhum_d-0১.png',
        description: 'Nijhum Dwip is a small island under Hatiya upazila. It is situated in Noakhali District in Bangladesh. Once it was called Char Osmani, Baluar Char, Golden Island Buffalo Herd at Nijhum Dwip A cluster of islands emerged in the early 1950s as an alluvium in the shallow estuary of the Bay of Bengal on the south of Noakhali.',
        location:{
            lat: 22.060189,
            lng: 91.008123
        }
